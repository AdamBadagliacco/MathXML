...
namespace Mathml
{
    //WordsToNumbers Class from https://www.c-sharpcorner.com/blogs/convert-words-to-numbers-in-c-sharp
    internal class WordsToNumbers
    {
        ...
        public static float ConvertToFloat(string numberString)
        {
            return (float)ConvertToNumbers(numberString);
        }
    }
}